...
<p align="center">
  <strong>v0.2.5 · 玩家测试版</strong> · 安装核心为 DLSS5-Autopilot <strong>v1.7.3</strong>
</p>
...
请从 [Releases](https://github.com/ha7rock/JustDLSS5/releases) 下载 Windows x64 包：`JustDLSS5-v0.2.5-windows-x64.zip`。
...
同版本还提供：`BUILD-INFO.json`（构建信息）、`JustDLSS5-v0.2.5-source-materials.zip`（应用及对应依赖源码）。
...
| 安装核心 | 自行处理 | 上游 | 当前为 Autopilot **v1.7.3**（`core/`） |
...
| 版本 | 随上游发布 | 当前为 **v1.7.3**（见 `backend-version.json`） |
| 界面 | 上游 | 独立 Qt 应用，中英双语 |
...
输出路径：`dist/v0.2.5/JustDLSS5/JustDLSS5.exe`。请保留同目录下的 `_internal`。
...
- [v0.2.5 说明](docs/RELEASE-v0.2.5.md)
...
<p align="center">JustDLSS5 · v0.2.5 玩家测试版 · MIT · 社区工具，与 NVIDIA 无关</p>

...
<p align="center">
  <strong>v0.2.9 · Player preview</strong> · install core: DLSS5-Autopilot <strong>v1.8.2</strong>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/engine-Autopilot%20v1.8.2-informational" alt="Autopilot v1.8.2">
...
Download the Windows x64 package from [Releases](https://github.com/ha7rock/JustDLSS5/releases): `JustDLSS5-v0.2.9-windows-x64.zip`.
...
The same release also includes `BUILD-INFO.json` (build metadata) and `JustDLSS5-v0.2.9-source-materials.zip` (application and matching dependency sources).
...
| Install core | Manual | Upstream | Currently Autopilot **v1.8.2** (`core/`) |
...
| Version | Upstream releases | Currently **v1.8.2** (`backend-version.json`) |
...
Output: `dist/v0.2.9/JustDLSS5/JustDLSS5.exe`. Keep `_internal` next to the executable.
...
- [docs/RELEASE-v0.2.9.md](docs/RELEASE-v0.2.9.md)
...
<p align="center">JustDLSS5 · v0.2.9 player preview · MIT · community tool, not affiliated with NVIDIA</p>
